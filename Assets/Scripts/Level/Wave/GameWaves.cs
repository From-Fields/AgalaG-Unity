        ...
        {   
            ...
            (
                ...
                new List<iWaveUnit>() 
                {
                    new WaveUnit<EnemyKamikaze>
                    (
                        new Vector2(-width * 0.85f, height * 1.2f),
                        new WaitSeconds(0),
                        new MoveTowards(new Vector2(-width * 0.85f, -height * 1.2f), speedModifier: 4),
                        new Queue<iEnemyAction>(new iEnemyAction[] { 
                            new MoveTowards(new Vector2(-width * 0.85f, height * 0.6f)),
                    ...
                    new WaveUnit<EnemyKamikaze>
                    (
                        new Vector2(-width * 0.55f, height * 1.2f),
                        new WaitSeconds(1f),
                        new MoveTowards(new Vector2(-width * 0.55f, -height * 1.2f), speedModifier: 4),
                        new Queue<iEnemyAction>(new iEnemyAction[] { 
                            new MoveTowards(new Vector2(-width * 0.55f, height * 0.6f)),
                            new WaitSeconds(tsuKamiWait),
                        }),
                        onDeath
                    ),
                    ...
                    new WaveUnit<EnemyKamikaze>
                    (
                        new Vector2(-width * 0.25f, height * 1.2f),
                        new WaitSeconds(2f),
                        new MoveTowards(new Vector2(-width * 0.25f, -height * 1.2f), speedModifier: 4),
                        new Queue<iEnemyAction>(new iEnemyAction[] { 
                            new MoveTowards(new Vector2(-width * 0.25f, height * 0.6f)),
                            new WaitSeconds(tsuKamiWait),
                        }),
                        onDeath
                    ),
                    ...
                    (
                        new Vector2(width * 0f, height * 1.2f),
                        new WaitSeconds(3f),
                        new MoveTowards(new Vector2(width * 0f, -height * 1.2f), speedModifier: 4),
                        new Queue<iEnemyAction>(new iEnemyAction[] { 
                            new MoveTowards(new Vector2(width * 0f, height * 0.6f)),
                            new WaitSeconds(tsuKamiWait),
                        }),
            ...
            (
                ...
                new List<iWaveUnit>() 
                {
                    ...
                    (
                        ...
                        new MoveTowards(new Vector2(width * 0.4f, -height * 1.2f), speedModifier: 4),
                        new Queue<iEnemyAction>(new iEnemyAction[] { 
                            new MoveTowards(new Vector2(-width * 0.7f, height * 0.7f)),
                            new WaitSeconds(1.5f),
                        }),
                        onDeath
                    ),
                    new WaveUnit<EnemyKamikaze>
                    (
                        new Vector2(-width * 0.65f, height * 1.2f),
                        new WaitSeconds(1.5f),
                        new MoveTowards(new Vector2(width * 0.6f, -height * 1.2f), speedModifier: 4),
                        new Queue<iEnemyAction>(new iEnemyAction[] { 
                            new MoveTowards(new Vector2(-width * 0.5f, height * 0.7f)),
                            new WaitSeconds(1.0f),
                        }),
                        onDeath
                    ),
                    new WaveUnit<EnemyKamikaze>
                    (
                        new Vector2(-width * 0.45f, height * 1.2f),
                        new WaitSeconds(2.0f),
                        new MoveTowards(new Vector2(width * 0.8f, -height * 1.2f), speedModifier: 4),
                        new Queue<iEnemyAction>(new iEnemyAction[] { 
                            new MoveTowards(new Vector2(-width * 0.3f, height * 0.7f)),
                            new WaitSeconds(0.5f),
                        }),
                        onDeath
                    ),
                    new WaveUnit<EnemyBumblebee>
                    (
                        new Vector2(width * 0.05f, height * 1.2f),
                        new WaitSeconds(0.3f),
                        new MoveTowards(new Vector2(-width * 0.55f, -height * 1.2f), speedModifier: 4),
                        new Queue<iEnemyAction>(new iEnemyAction[] { 
                            new MoveTowards(new Vector2(width * 0.05f, height * 0.7f)),
                            new Shoot(3.6f),
                        }),
                        onDeath
                    ),
                    ...
                    (
                        ...
                        new MoveTowards(new Vector2(-width * 0.15f, -height * 1.2f), speedModifier: 4),
                        new Queue<iEnemyAction>(new iEnemyAction[] { 
                            new MoveTowards(new Vector2(width * 0.45f, height * 0.7f)),
                            new Shoot(3.3f),
                        }),
                        onDeath
                    ),
                    ...
                    (
                        ...
                        new MoveTowards(new Vector2(width * 0.25f, -height * 1.2f), speedModifier: 4),
                        new Queue<iEnemyAction>(new iEnemyAction[] { 
                            new MoveTowards(new Vector2(width * 0.85f, height * 0.7f)),
                            new Shoot(3.0f),
                        }),
                        onDeath
                    ),
            ...
            (
                ...
                new List<iWaveUnit>() 
                {
                    ...
                    (
                        ...
                        new WaitSeconds(2.0f),
                        new MoveTowards(new Vector2(-width * 1.1f, -height * 1.1f), speedModifier: 4),
                        new Queue<iEnemyAction>(new iEnemyAction[] { 
                            new MoveTowards(new Vector2(-width * 0.3f, height * 0.6f)),
                    ...
                    new WaveUnit<EnemyGemini>
                    (
                        new Vector2(-width * 1.5f, -height * 0.4f),
                        new WaitSeconds(0.0f),
                        new MoveAndShoot(new Vector2(width * 1.1f, height * 0.3f)),
                        new Queue<iEnemyAction>(new iEnemyAction[] { 
                            new MoveTowards(new Vector2(-width * 0.7f, height * 0.3f)),
                            new Shoot(3.0f),
                        }),
                        onDeath
                    ),
                    new WaveUnit<EnemyGemini>
                    (
                        new Vector2(-width * 1.1f, height * 0.1f),
                        new WaitSeconds(0.5f),
                        new MoveAndShoot(new Vector2(width * 1.1f, -height * 0.2f)),
                        new Queue<iEnemyAction>(new iEnemyAction[] { 
                            new MoveTowards(new Vector2(-width * 0.3f, -height * 0.2f)),
                            new Shoot(3.0f),
                        }),
                        onDeath
                    ),
                    new WaveUnit<EnemyBumblebee>
                    (
                        new Vector2(width * 0f, height * 1.1f),
                        new WaitSeconds(2.5f),
                        new MoveAndShoot(new Vector2(-width * 1.2f, height * 0.6f)),
                        new Queue<iEnemyAction>(new iEnemyAction[] { 
                            new MoveTowards(new Vector2(width * 0f, height * 0.6f)),
