...
public class TestEnemy : Enemy
{
    ...
    private void Start()
    {
        ...
        queue.Enqueue(new MoveTowards(1, 0.05f, 20, 0.1f, new Vector2(-1, 3)));
        queue.Enqueue(new Shoot(2));
        queue.Enqueue(new MoveTowards(5, 0.05f, 40, 1f, target.GetComponentInChildren<Entity>()));
    ...
    {
        _rigidbody.velocity = Vector2.Lerp(_rigidbody.velocity, direction * speed * Time.fixedDeltaTime, Time.fixedDeltaTime * speed);
    }
